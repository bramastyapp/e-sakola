...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #D6E6F2;">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="<?= base_url('admin/siswa'); ?>" style=" background-color: #303481;">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url('admin/nilai'); ?>" style=" color: #303481;">
                <i class="fas fa-calculator" style=" color: #303481;"></i>
                <span>Nilai</span></a>
        </li>

        <!-- Divider -->
        <hr class="sidebar-divider" style=" background-color: #303481;">
