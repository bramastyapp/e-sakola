        ...
        <div class="container">
            <div class="container mt-5">
                ...
                <div class="cardku row mt-2">
                    ...
                    <div class="col-lg-7" style="color: black; font-size: smaller;">
                        <div class="mt-3">
                            <input type="number" class="form-control form-control-sm" placeholder="Masukkan no induk siswa" name="id_siswa"></input>
            ...
            <div class="container mt-3">
                ...
                <div class="cardku row mt-2">
                    <div class="card-body mt-2 form-group col-lg ml-4 mr-4">
                        <select class="form-control form-control-sm col-lg" name="id_kelas" required>
                            <option disabled selected value>- Pilih Kelas -</option>
                            <?php foreach ($kelas as $k) : ?>
                                <option value="<?= $k['id_kelas']; ?>"><?= $k['nama_kelas']; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('id_kelas', '<small class="form-text text-danger pl-3">', '</small>'); ?>
                    </div>
                </div>
            </div>
            <br>
